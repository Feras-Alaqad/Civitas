            ...
            <div class="md:w-7/12 lg:w-1/2">
                ...
                <div class="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                    <div class="mt-8 flex gap-4 md:items-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700 dark:text-white">Instant National-ID Lookup</h3>
                            <p class="text-gray-600 dark:text-gray-300">Search by national ID, name, email, or phone across 10,000+ records in milliseconds — and every lookup is recorded in the audit log.</p>
                        </div>
                    </div>
                    <div class="pt-4 flex gap-4 md:items-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700 dark:text-white">Background CSV Imports</h3>
                            <p class="text-gray-600 dark:text-gray-300">Upload large citizen lists and let the queue process them in the background — with live progress, validation, and no server crashes.</p>
                        </div>
                    </div>
                </div>
            </div>
