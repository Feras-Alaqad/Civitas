        ...
        <div :class="menuToggle ? 'flex' : 'hidden'" class="shadow-theme-md w-full items-center justify-between gap-4 px-5 py-4 lg:flex lg:justify-end lg:px-0 lg:shadow-none">
                            ...
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5" href="#">
                                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                        <img src="{{ asset('images/user/user-0' . ($i + 2) . '.jpg') }}" alt="User" class="overflow-hidden rounded-full"/>
                                    ...
                                    <span class="block">
                                        <span class="text-theme-sm mb-1.5 block text-gray-500 dark:text-gray-400">
                                            ...
                                            <span class="font-medium text-gray-800 dark:text-white/90">Project</span>
                                        </span>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen" class="shadow-theme-lg dark:bg-gray-dark absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800">
                    <div>
                        <span class="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">{{ Auth::user()->name ?? 'User' }}</span>
                        <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">{{ Auth::user()->Username ?? 'user' }}</span>
                    </div>
